...
def main_worker(index, opt):
    ...
    #M3d-CAM injection
    model = medcam.inject(model, output_dir="attention_maps", backend="ggcam",
                          layer='layer4', label=0, data_shape='default',
                          save_maps=True, save_pickle=False, save_scores=False,
                          evaluate=False, metric='wioa', threshold='otsu',
                          retain_graph=True, return_score=False, replace=True,
                          return_attention=False, cudnn=False, enabled=True)
